...
LOCKSCRIPT="/usr/bin/i3lock-fancy"
...
ROFI_TEXT="Menu:"
ROFI_OPTIONS=(-width -11 -location 5 -hide-scrollbar -bw 2 -m -3) # -theme-str '#window { anchor: southeast;}')
...
menu=(
 ...
 # [Hibernate]="suspend && ${LOCKSCRIPT}"
  [Suspend]="systemctl suspend & ${LOCKSCRIPT}"
  [Halt]="systemctl halt"
  [Lock]="${LOCKSCRIPT}"
  [Logout]="i3-msg exit"
  [Cancel]=""
